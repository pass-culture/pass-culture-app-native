...
Pour enregistrer votre flux de test, il faut :

```bash
# Pour record tous les tests
maestro record .maestro

# Pour record un test natif
maestro record .maestro/<nomDuTest.yml>

# Pour record un test web
maestro record .maestro/<nomDuTest.web.yml>
```
