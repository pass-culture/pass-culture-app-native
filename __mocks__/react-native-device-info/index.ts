...
const asyncFn = (response: unknown) => () => jest.fn(() => Promise.resolve(response))
const syncFn = (response: unknown) => () => jest.fn(() => response)
const makeFns = (response: unknown) => [asyncFn(response), syncFn(response)]
