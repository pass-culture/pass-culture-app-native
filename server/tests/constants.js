...
exports.VENUE_RESPONSE_ALTERNATIVE_SNAP = exports.VENUE_RESPONSE_SNAP = exports.OFFER_RESPONSE_SNAP = exports.TEST_HTML = void 0;
exports.TEST_HTML = `<!doctype html>
<html lang="fr">
  <head>
    <meta charset="utf-8">
...
exports.OFFER_RESPONSE_SNAP = {
    ...
    description: 'Depuis de nombreuses années, Christine vit sous un pont, isolée de toute famille et amis. Par une nuit comme il n’en existe que dans les contes, un jeune garçon de 8 ans fait irruption devant son abri. Suli ne parle pas français, il est perdu, séparé de sa mère…\nTous les détails du film sur AlloCiné: https://www.allocine.fr/film/fichefilm_gen_cfilm=199293.html',
    expenseDomains: ['all'],
    isDigital: false,
    isDuo: true,
    isEducational: false,
...
exports.VENUE_RESPONSE_ALTERNATIVE_SNAP = {
    id: 5544,
