...
echo "# $1">> trace_routes.md
echo "## Used routes:">> trace_routes.md
cat used_routes.txt >> trace_routes.md
echo "## Unused routes:">>trace_routes.md
cat unused_routes.txt >> trace_routes.md
echo "">>trace_routes.md
