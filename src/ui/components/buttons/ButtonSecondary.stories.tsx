...
const Template: VariantsStory<typeof ButtonSecondary> = (
  args: React.ComponentProps<typeof ButtonSecondary>
) => <VariantsTemplate variants={variantConfig} Component={ButtonSecondary} defaultProps={args} />
