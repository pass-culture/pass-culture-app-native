...
describe('<AppModal />', () => {
  ...
  describe("adapt modal's height", () => {
    it('should have a default height', () => {
      ...
      expect(modalContainer.props.height).toEqual(432)
    })
    ...
    it("should adapt to the content's height", () => {
      ...
      expect(modalContainer.props.height).toEqual(332)
    })
    ...
    describe('should adapt when virtual keyboard is', () => {
      ...
      it('displayed', () => {
        ...
        expect(modalContainer.props.height).toEqual(724)
      })
    ...
    it("should adapt to the header's height", () => {
      ...
      expect(modalContainer.props.height).toEqual(422)
    })
