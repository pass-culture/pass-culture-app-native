...
const LINEAR_GRADIENT_ID = 'BicolorFavorite-LinearGradient'

export const NotMemoizedBicolorFavorite: React.FC<BicolorIconInterface> = ({
  size = 32,
  color,
  color2,
  thin = false,
...
export const BicolorFavorite = React.memo(NotMemoizedBicolorFavorite)
