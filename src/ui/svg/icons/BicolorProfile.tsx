...
const NotMemoizedBicolorProfile: React.FC<BicolorIconInterface> = ({
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 20 26" testID={testID} aria-hidden>
      <Defs>
...
export const BicolorProfile = React.memo(NotMemoizedBicolorProfile)
