...
const NotMemoizedBicolorSignal: React.FunctionComponent<AccessibleIcon> = ({
  size,
  color,
  color2,
  accessibilityLabel,
...
export const BicolorSignal = React.memo(
  styled(NotMemoizedBicolorSignal).attrs(({ color, color2, size, theme }) => ({
