...
const BicolorProfileDeletionSvg: React.FunctionComponent<AccessibleIcon> = ({
  size,
  color,
  color2,
  accessibilityLabel,
...
export const ProfileDeletion = styled(BicolorProfileDeletionSvg).attrs(
  ({ color, color2, size, theme }) => ({
    color: color ?? theme.colors.black,
    color2: color2 ?? theme.colors.black,
    size: size ?? theme.illustrations.sizes.medium,
  })
)``

export const BicolorProfileDeletion = styled(BicolorProfileDeletionSvg).attrs(
  ({ size, theme }) => ({
    size: size ?? theme.illustrations.sizes.medium,
  })
)``
