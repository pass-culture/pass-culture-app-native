...
const LibrariesMediaLibrariesSvg: React.FunctionComponent<AccessibleIcon> = ({
  size,
  accessibilityLabel,
  testID,
}) => {
  return (
    <AccessibleSvg
      ...
      fill="none"
      testID={testID}>
      <G clipPath="url(#clip0_1909_614)">
        <G filter="url(#filter0_d_1909_614)">
          <Path
            ...
            fill="url(#paint0_linear_1909_614)"
          />
        </G>
        <G filter="url(#filter1_d_1909_614)">
          <Path
            ...
            fill="url(#paint1_linear_1909_614)"
          />
        </G>
        <G filter="url(#filter2_d_1909_614)">
          <Path
            ...
            fill="url(#paint2_linear_1909_614)"
          />
        </G>
...
export const LibrariesMediaLibraries = styled(LibrariesMediaLibrariesSvg).attrs(
  ({ size, theme }) => ({
