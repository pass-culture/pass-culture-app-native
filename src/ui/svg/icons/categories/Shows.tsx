...
export const Shows: React.FunctionComponent<AccessibleIcon> = ({ accessibilityLabel, testID }) => {
  return (
    <AccessibleSvg
      ...
      testID={testID}>
      <G clipPath="url(#clip0_1981_1401)">
        <G filter="url(#filter0_d_1981_1401)">
          <Path
            ...
            fill="url(#paint0_linear_1981_1401)"
          />
        </G>
        <Rect
          x={18.001}
          ...
          fill="#FFB496"
        />
        <G filter="url(#filter1_d_1981_1401)">
          <Path
            ...
            fill="url(#paint1_linear_1981_1401)"
          />
        </G>
        <Rect
          x={26.5752}
