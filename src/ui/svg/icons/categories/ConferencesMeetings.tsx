...
const ConferencesMeetingsSvg: React.FunctionComponent<AccessibleIcon> = ({
  ...
  return (
    <AccessibleSvg
      ...
      testID={testID}>
      <G clipPath="url(#clip0_1981_1386)">
        <G filter="url(#filter0_d_1981_1386)">
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <G filter="url(#filter1_d_1981_1386)">
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill="url(#paint0_linear_1981_1386)"
          />
        </G>
        <G filter="url(#filter2_d_1981_1386)">
          <Path
        ...
        <G filter="url(#filter3_d_1981_1386)">
          <Path
            ...
            fill="url(#paint1_radial_1981_1386)"
          />
        </G>
        <Path
          opacity={0.4}
          ...
          fill="url(#paint2_radial_1981_1386)"
        />
        <Path
