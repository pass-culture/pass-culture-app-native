...
const ConferencesMeetingsSvg: React.FunctionComponent<AccessibleIcon> = ({
  ...
  return (
    <AccessibleSvg
      ...
      fill="none"
      testID={testID}>
      <G clipPath="url(#clip0_1909_774)">
        <G filter="url(#filter0_d_1909_774)">
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
        ...
        <G filter="url(#filter1_d_1909_774)">
          <Path
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill="url(#paint0_linear_1909_774)"
          />
        </G>
        <G filter="url(#filter2_d_1909_774)">
          <Path
        ...
        <G filter="url(#filter3_d_1909_774)">
          <Path
            ...
            fill="url(#paint1_radial_1909_774)"
          />
        </G>
        <Path
          opacity={0.4}
          ...
          fill="url(#paint2_radial_1909_774)"
        />
        <Path
