...
export const ConcertsFestivals: React.FunctionComponent<AccessibleIcon> = ({
  accessibilityLabel,
  testID,
}) => {
  return (
    <AccessibleSvg
      ...
      testID={testID}>
      <G clipPath="url(#clip0_1981_1385)">
        <G filter="url(#filter0_d_1981_1385)">
          <Path
            ...
            fill="url(#paint0_radial_1981_1385)"
          />
        </G>
        <G filter="url(#filter1_d_1981_1385)">
          <Path
            d="M40.6505 49.5341L30.99 39.7539L-7.07227 81.7191L-0.629998 88.2392L40.6505 49.5341Z"
            fill="url(#paint1_linear_1981_1385)"
          />
        </G>
        <Path
          ...
          fillOpacity={0.2}
        />
        <G filter="url(#filter2_d_1981_1385)">
          <Path
            ...
            fill="url(#paint2_linear_1981_1385)"
          />
        </G>
        <Path
        ...
        <Path
          ...
          fill="#FBDBAC"
        />
        <G filter="url(#filter3_d_1981_1385)">
          <Path
            ...
            fill="url(#paint3_linear_1981_1385)"
          />
        </G>
        <Path
