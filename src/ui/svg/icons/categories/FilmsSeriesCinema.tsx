...
export const FilmsSeriesCinema: React.FunctionComponent<AccessibleIcon> = ({
  ...
  const { id: maskId, fill: mask } = svgIdentifier()
  ...
  return (
    <AccessibleSvg
      ...
      <G clipPath={clipPath}>
        ...
        <StyledMask id={maskId} maskUnits="userSpaceOnUse" x={-4} y={39} width={65} height={21}>
          <Path
        ...
        <StyledMask id={maskId1} maskUnits="userSpaceOnUse" x={-21} y={12} width={57} height={53}>
          <Path
