...
const NotMemoizedBicolorLocationBuilding: React.FunctionComponent<BicolorIconInterface> = ({
  size = 32,
...
export const BicolorLocationBuilding = React.memo(NotMemoizedBicolorLocationBuilding)
