...
import { Defs, Path, Stop, LinearGradient } from 'react-native-svg'
...
const BicolorUserBlockedSvg: React.FC<AccessibleBicolorIconInterface> = ({
  size,
  color,
  color2,
  accessibilityLabel,
...
export const BicolorUserBlocked = styled(BicolorUserBlockedSvg).attrs(
