...
const LINEAR_GRADIENT_ID = 'BicolorBookings-LinearGradient'
const LINEAR_GRADIENT_2_ID = 'BicolorBookings-LinearGradient2'

export const NotMemoizedBicolorBookings: React.FC<BicolorIconInterface> = ({
  size = 32,
  color,
  color2,
  thin = false,
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 44 44" testID={testID}>
      <Defs>
        ...
        <LinearGradient id={LINEAR_GRADIENT_2_ID} x1="-537.105%" x2="515.395%" y1="50%" y2="50%">
          <Stop offset="0%" stopColor={primaryColor} />
          <Stop offset="100%" stopColor={secondaryColor} />
        </LinearGradient>
      </Defs>
      <G fill="none" fillRule="evenodd">
        <G fillRule="nonzero" strokeWidth={thin ? 0 : 0.5}>
          ...
          <Path
            ...
            stroke={`url(#${LINEAR_GRADIENT_2_ID})`}
...
export const BicolorBookings = React.memo(NotMemoizedBicolorBookings)
