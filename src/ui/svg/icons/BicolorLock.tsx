...
export const BicolorLock: React.FC<BicolorIconInterface> = ({
  size = 32,
  color,
  color2,
  testID,
  ...
  <Svg width={size} height={size} viewBox="0 0 37 36" testID={testID}>
    <Defs>
      <LinearGradient id="906z09hf4a" x1="16.056%" x2="83.944%" y1="0%" y2="100%">
        <Stop offset="0%" stopColor={color ?? ColorsEnum.PRIMARY} />
        <Stop offset="100%" stopColor={color2 ?? ColorsEnum.SECONDARY} />
      </LinearGradient>
    </Defs>
    <G fill="none" fill-rule="evenodd">
      <G fill="url(#906z09hf4a)" transform="translate(-22.000000, -433.000000)">
        <G>
          <Path
