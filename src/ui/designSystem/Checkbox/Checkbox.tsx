...
import { RequiredFormat, getRequiredLabel } from 'ui/designSystem/utils/getRequiredLabel'
      ...
      <ContentContainer>
        ...
        <RightBox>
          <Label state={state} {...hoverProps}>
            {label}
            {required ? <RequiredLabel>{getRequiredLabel(requiredFormat)}</RequiredLabel> : null}
          </Label>
          {description ? (
...
const RequiredLabel = styled(Typo.BodyAccentXs)(({ theme }) => ({
