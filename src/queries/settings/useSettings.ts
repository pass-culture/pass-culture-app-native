/**
 * These hooks can be used to access settings while being less coupled with react-query.
...
export const useGetPacificFrancToEuroRate = () => {
...
export const useGetBonificationBonusAmount = () => {
  const queryResult = useSettingsQuery({
...
export const useGetBonificationQfThreshold = () =>
  useSettingsQuery({
