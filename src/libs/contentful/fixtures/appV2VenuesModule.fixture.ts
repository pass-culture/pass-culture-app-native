import { AppV2VenuesContentModel, ContentTypes } from 'libs/contentful/types'

// This fixture reflects the contentful data after the resolveResponse formatting
export const appV2VenuesNatifModuleFixture: AppV2VenuesContentModel = {
  sys: {
    ...
    revision: 9,
    contentType: {
      sys: { type: 'Link', linkType: 'ContentType', id: ContentTypes.VENUES_PLAYLIST_APP_V2 },
    },
    locale: 'en-US',
  },
  fields: {
