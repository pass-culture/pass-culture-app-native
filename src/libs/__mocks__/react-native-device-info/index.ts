...
export const asyncFn = (response: unknown) => () => jest.fn(() => Promise.resolve(response))
export const syncFn = (response: unknown) => () => jest.fn(() => response)
export const makeFns = (response: unknown) => [asyncFn(response), syncFn(response)]

export const [stringFnAsync, stringFnSync] = makeFns('unknown')
export const [numberFnAsync, numberFnSync] = makeFns(-1)
export const [arrayFnAsync, arrayFnSync] = makeFns([])
export const [booleanFnAsync, booleanFnSync] = makeFns(false)
export const [objectFnAsync, objectFnSync] = makeFns({})

export const numberAsyncHookResultHook = () => jest.fn(() => ({ loading: false, result: -1 }))
export const booleanAsyncHookResultHook = () => jest.fn(() => ({ loading: false, result: false }))
export const stringAsyncHookResultHook = () =>
  jest.fn(() => ({ loading: false, result: 'unknown' }))
...
const t = {
  ...
  stringFnAsync,
  stringFnSync,
  numberAsyncHookResultHook,
  booleanAsyncHookResultHook,
  stringAsyncHookResultHook,
  diMock,
}
