import { convertEuroToCents, convertCentsToEuros } from './pricesConversion'

describe('convertEuroToCents', () => {
  it('should convert euros to cents without rounding', () => {
...
describe('convertCentsToEuros', () => {
  it('should convert cents to euros without rounding', () => {
