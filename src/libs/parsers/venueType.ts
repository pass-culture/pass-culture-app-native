...
const MAP_TYPE_TO_ICON: {
  [k in VenueTypeCodeKey]: React.FC<AccessibleIcon>
} = {
...
export const mapVenueTypeToIcon = (types: VenueTypeCodeKey | null): React.FC<AccessibleIcon> => {
