...
export const MAP_VENUE_TYPE_TO_LABEL: {
  ...
  [VenueTypeCodeKey.BOOKSTORE]: 'Librairies',
  [VenueTypeCodeKey.CONCERT_HALL]: 'Musique - Salles de concerts',
  [VenueTypeCodeKey.CREATIVE_ARTS_STORE]: 'Magasins d’arts créatifs',
  [VenueTypeCodeKey.DISTRIBUTION_STORE]: 'Magasins culturels',
  [VenueTypeCodeKey.CULTURAL_CENTRE]: 'Centres culturels',
  [VenueTypeCodeKey.DIGITAL]: 'Offre numérique',
  [VenueTypeCodeKey.FESTIVAL]: 'Festivals',
  [VenueTypeCodeKey.GAMES]: 'Jeux / Jeux vidéos',
  [VenueTypeCodeKey.LIBRARY]: 'Bibliothèques / Médiathèques',
  [VenueTypeCodeKey.MUSEUM]: 'Musées',
  [VenueTypeCodeKey.MUSICAL_INSTRUMENT_STORE]: 'Musique - Magasins d’instruments',
  [VenueTypeCodeKey.MOVIE]: 'Cinémas - Salles de projection',
  [VenueTypeCodeKey.TRAVELING_CINEMA]: 'Cinémas itinérants',
  [VenueTypeCodeKey.OTHER]: 'Autre type de lieu',
  [VenueTypeCodeKey.PATRIMONY_TOURISM]: 'Patrimoine et tourisme',
  [VenueTypeCodeKey.PERFORMING_ARTS]: 'Spectacles vivants',
  [VenueTypeCodeKey.RECORD_STORE]: 'Musique - Disquaires',
