...
describe('useCategoryId', () => {
  it.each`
    ...
    ${SubcategoryIdEnum.SUPPORT_PHYSIQUE_MUSIQUE_CD}     | ${CategoryIdEnum.MUSIQUE_ENREGISTREE}
    ${SubcategoryIdEnum.SUPPORT_PHYSIQUE_MUSIQUE_VINYLE} | ${CategoryIdEnum.MUSIQUE_ENREGISTREE}
