...
class AppLifecycleManagerService {
  ...
  private initializeWebListeners() {
    ...
    window.addEventListener('pagehide', this.boundWebHandlers.pageHide)
    window.addEventListener('beforeunload', this.boundWebHandlers.beforeUnload)
  ...
  private removeWebListeners() {
    ...
    window.removeEventListener('pagehide', this.boundWebHandlers.pageHide)
    window.removeEventListener('beforeunload', this.boundWebHandlers.beforeUnload)
