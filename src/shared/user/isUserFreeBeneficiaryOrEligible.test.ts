...
describe('isUserFreeBeneficiaryOrEligible', () => {
  it.each`
    ...
    ${{}}                                                                                                           | ${false}
    ${undefined}                                                                                                    | ${false}
    ${{ eligibilityType: UserEligibilityType.ELIGIBLE_CREDIT_V3_15_16 }}                                            | ${true}
    ...
    ${{ eligibilityType: UserEligibilityType.ELIGIBLE_CREDIT_V3_15_16, creditType: undefined }}                     | ${true}
    ${{ eligibilityType: UserEligibilityType.ELIGIBLE_CREDIT_V3_15_16, creditType: UserCreditType.CREDIT_V3_FREE }} | ${true}
    ...
    ${{ eligibilityType: UserEligibilityType.ELIGIBLE_CREDIT_V3_15_16, creditType: UserCreditType.CREDIT_V3_18 }}   | ${true}
