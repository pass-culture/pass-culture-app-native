...
export class BaseAPI {
  ...
  public getConfiguration = async () => {
    ...
    this.configuration = isE2e ? { ...this.configuration, basePath: E2E_BASE_URL } : this.configuration
...
export const DefaultApiFp = function(api: DefaultApi, configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async postnativev1meculturalSurvey(body?: CulturalSurveyRequest, options?: any): Promise<EmptyResponse> {
...
export class DefaultApi extends BaseAPI {
  ...
  public async postnativev1meculturalSurvey(body?: CulturalSurveyRequest, options?: any) {
    const configuration = await this.getConfiguration()
    return DefaultApiFp(this, configuration).postnativev1meculturalSurvey(body, options)
  }
  /**
    *
    * @summary create_favorite <POST>
