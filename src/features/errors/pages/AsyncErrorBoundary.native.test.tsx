...
describe('AsyncErrorBoundary component', () => {
  ...
  it.each([
    ...
    expect(eventMonitoring.captureExceptionAsInfo).toHaveBeenCalledWith(error.message)
  })
  ...
  describe('should capture message', () => {
    it('when error is ScreenError', () => {
      ...
      expect(eventMonitoring.captureExceptionAsInfo).toHaveBeenCalledWith('error-1')
    })
  })
})
