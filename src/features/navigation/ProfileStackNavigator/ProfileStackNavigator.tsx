...
import { useIsSignedIn } from 'features/navigation/TabBar/TabStackNavigator'
...
export const profileStackNavigatorPathDefinition = {
...
export const profileStackNavigatorPathConfig =
  createPathConfigForStaticNavigation(ProfileStackNavigator)
