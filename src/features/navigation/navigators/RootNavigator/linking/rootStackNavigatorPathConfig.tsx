...
import { cheatcodesStackNavigatorPathConfig } from 'features/navigation/navigators/CheatcodesStackNavigator/CheatcodesStackNavigator'
import { onboardingStackNavigatorPathConfig } from 'features/navigation/navigators/OnboardingStackNavigator/OnboardingStackNavigator'
import { profileStackNavigatorPathConfig } from 'features/navigation/navigators/ProfileStackNavigator/ProfileStackNavigator'
import { subscriptionStackNavigatorPathConfig } from 'features/navigation/navigators/SubscriptionStackNavigator/SubscriptionStackNavigator'
import { tabNavigatorPathConfig } from 'features/navigation/navigators/TabNavigator/TabStackNavigator'
...
export const rootStackNavigatorPathDefinition = {
  Account: {
    screens: {
      AccountCreated: {
...
export const rootStackNavigatorPathConfig = {
  screens: {
    TabNavigator: {
      screens: tabNavigatorPathConfig,
    },
