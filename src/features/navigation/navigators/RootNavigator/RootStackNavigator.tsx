...
import { RootScreenNames } from 'features/navigation/navigators/RootNavigator/types.ts'
import { useInitialScreen } from 'features/navigation/navigators/RootNavigator/useInitialScreenConfig'
import { useShowMandatoryUpdatePersonalData } from 'features/navigation/navigators/RootNavigator/useShowMandatoryUpdatePersonalData'
import { withWebWrapper } from 'features/navigation/navigators/RootNavigator/withWebWrapper'
import { BottomTabScreen } from 'features/navigation/navigators/TabNavigator/TabStackNavigator.tsx'
...
const OnboardingScreen = lazy(() => import('../OnboardingStackNavigator/OnboardingStackNavigator'))
const ProfileScreen = lazy(() => import('../ProfileStackNavigator/ProfileStackNavigator.tsx'))
const SubscriptionScreen = lazy(
  () => import('../SubscriptionStackNavigator/SubscriptionStackNavigator.tsx')
)
