...
import { BottomTabScreen } from 'features/navigation/navigators/TabNavigator/TabStackNavigator'
...
const ProfileScreen = lazy(() => import('../ProfileStackNavigator/ProfileStackNavigator'))
const SubscriptionScreen = lazy(
  () => import('../SubscriptionStackNavigator/SubscriptionStackNavigator')
)
const AchievementsScreen = lazy(() => import('features/achievements/pages/Achievements'))
