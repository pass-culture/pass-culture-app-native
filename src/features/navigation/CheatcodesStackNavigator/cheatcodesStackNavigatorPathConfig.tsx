...
export const cheatcodesStackNavigatorPathConfig: PathConfigMap<CheatcodesStackParamList> = {
  ...
  CheatcodesNavigationNewIdentificationFlow: 'cheatcodes/identity-check/new-identification-flow',
  ...
  CheatcodesScreenSecondaryPageWithBlurHeader: 'cheatcodes/other/secondary-page-with-blur-header',
