...
export const ProfileStackNavigator = createNativeStackNavigator(profileStackNavigatorPathConfig)
export const ProfileScreen = createComponentForStaticNavigation(ProfileStackNavigator, 'Profile')
export const SubscriptionStackNavigator = createNativeStackNavigator(
  subscriptionStackNavigatorPathConfig
)
export const SubscriptionScreen = createComponentForStaticNavigation(
...
export const StaticRootStackNavigator = createNativeStackNavigator({
  screenLayout: ({ children }) => <Suspense fallback={<LoadingPage />}>{children}</Suspense>,
  ...
  groups: {
    Home: {
      screens: {
        ...
        //   screen: lazy(() => import('../../CheatcodesStackNavigator/CheatcodesStackNavigator')),
        // },
        ProfileStackNavigator: {
...
export const rootscreens = createPathConfigForStaticNavigation(StaticRootStackNavigator)
