...
describe('<BookingConfirmation />', () => {
  ...
  describe('qualtrics survey modal', () => {
    ...
    it('should render modal', async () => {
      ...
      expect(await screen.findByTestId('Donner mon avis - Nouvelle fenêtre')).toBeOnTheScreen()
    })
    ...
    it('should not render modal when user has already seen it', async () => {
      ...
      expect(screen.queryByTestId('Donner mon avis - Nouvelle fenêtre')).not.toBeOnTheScreen()
    })
  })
})
