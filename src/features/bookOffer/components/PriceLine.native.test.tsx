...
describe('<PriceLine />', () => {
  ...
  it('should show total price', () => {
    render(reactQueryProviderHOC(<PriceLine unitPrice={500} quantity={1} />))
  ...
  it('should show price details', () => {
    render(
      reactQueryProviderHOC(<PriceLine unitPrice={500} quantity={2} attributes={attributes} />)
    )
  ...
  it("should not show cinema's attributes when offer has not attributes", () => {
    render(reactQueryProviderHOC(<PriceLine unitPrice={500} quantity={2} attributes={[]} />))

    expect(screen.queryByTestId('price-line-attributes')).not.toBeOnTheScreen()
  })

  it('should set default quantity to 1', () => {
    render(reactQueryProviderHOC(<PriceLine unitPrice={500} />))
