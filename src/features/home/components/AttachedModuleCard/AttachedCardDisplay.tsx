...
const Container = styled.View<{ shouldFixHeight: boolean; bottomBannerText?: string }>(
  ({ theme, shouldFixHeight, bottomBannerText }) => ({
    ...
    borderTopLeftRadius: theme.designSystem.size.spacing.m,
    borderTopRightRadius: theme.designSystem.size.spacing.m,
    borderBottomLeftRadius: bottomBannerText ? 0 : theme.designSystem.size.spacing.m,
    borderBottomRightRadius: bottomBannerText ? 0 : theme.designSystem.size.spacing.m,
