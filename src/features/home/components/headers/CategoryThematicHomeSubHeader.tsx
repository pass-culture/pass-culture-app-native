...
type CategoryThematicSubHeaderProps = Omit<CategoryThematicHeader, 'type'>

export const CategoryThematicHomeSubHeader: FunctionComponent<CategoryThematicSubHeaderProps> = ({
  title,
  subtitle,
  imageUrl,
}) => {
