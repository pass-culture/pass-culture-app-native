...
type HighligthThematicSubHeaderProps = Omit<HighlightThematicHeader, 'type'>
...
export const HighlightThematicHomeSubHeader: FunctionComponent<HighligthThematicSubHeaderProps> = ({
  title,
  subtitle,
  imageUrl,
  beginningDate,
