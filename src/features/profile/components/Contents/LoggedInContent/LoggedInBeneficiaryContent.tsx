...
import { loggedInBeneficiaryContentConfig } from 'features/profile/components/Contents/LoggedInContent/loggedInBeneficiaryContentConfig'
...
export const LoggedInBeneficiaryContent = ({ user }: Props) => {
