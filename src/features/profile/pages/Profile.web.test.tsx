...
// import { render, act, fireEvent, superFlushWithAct } from 'tests/utils/web'
...
describe('Profile component', () => {
  ...
  describe('user settings section', () => {
    ...
    describe('geolocation switch', () => {
      it.skip('should display switch ON if geoloc permission is granted', async () => {
        // mockPermissionState = GeolocPermissionState.GRANTED
      ...
      it.skip('should display switch OFF if geoloc permission is denied', async () => {
      ...
      it.skip('should open "Deactivate geoloc" modal when clicking on ACTIVE switch and call mockFavoriteDispatch()', async () => {
        ...
        // })
        // fireEvent.click(getByTestId('geolocation'))
  ...
  describe('Analytics', () => {
    it.skip('should log event ProfilScrolledToBottom when user reach end of screen', async () => {
      // // eslint-disable-next-line local-rules/independant-mocks
      // mockedUseAuthContext.mockImplementation(() => ({ isLoggedIn: true }))
      // const { getByTestId } = await renderProfile()
