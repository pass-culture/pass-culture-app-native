...
describe('Signup Form', () => {
  ...
  describe('Go back button', () => {
    ...
    it.skip('should not display backButton on confirmation email sent page', async () => {
      simulateSignupSuccess()
      renderSignupForm()
  ...
  it.skip('should show email sent confirmation on signup success', async () => {
    simulateSignupSuccess()
    renderSignupForm()
  ...
  describe('API', () => {
    it.skip('should create account when clicking on AcceptCgu button with trustedDevice', async () => {
      simulateSignupSuccess()
