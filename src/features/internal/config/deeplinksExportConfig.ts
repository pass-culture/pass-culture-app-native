...
import { AllNavParamList } from 'features/navigation/navigators/RootNavigator/types'

export type ScreensUsedByMarketing =
  | 'Offer'
  | 'Venue'
  | 'VenueMap'
  | 'Home'
...
export const SCREENS_CONFIG: {
  ...
  Offer: {
    id: {
      ...
      serverValidator: (value: unknown) => api.getNativeV3OfferofferId(Number(value)),
    },
  },
  VenueMap: {},
  Venue: {
