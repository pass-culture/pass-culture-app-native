...
describe('buildQueryHelper', () => {
  ...
  it('should append "AND NOT _tags:"is_future"" to filters', () => {
    ...
    expect(result.params).toHaveProperty(
      'filters',
      'offer.subcategoryId:"CONCERT" AND NOT _tags:"is_future"'
    )
  })
  ...
  it('should combine all parameters when provided', () => {
    ...
    expect(result).toEqual({
      ...
      params: {
        ...
        filters: 'offer.subcategoryId:"CONCERT" AND NOT _tags:"is_future"',
