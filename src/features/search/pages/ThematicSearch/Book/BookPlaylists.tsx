...
export const BookPlaylists: React.FC = () => {
  ...
  return bookGtlPlaylists.map((playlist) => (
    <GtlPlaylistContainer key={playlist.entryId}>
      <GtlPlaylist playlist={playlist} analyticsFrom="thematicsearch" route="ThematicSearch" />
