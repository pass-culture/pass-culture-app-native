...
describe('getRefundRules', () => {
  it.each`
    ...
    ${1000}     | ${Currency.EURO}                | ${10}                  | ${exBeneficiaryUser} | ${'Les 10\u00a0€ ne seront pas recrédités sur ton pass Culture car il est expiré.'}
    ${100000}   | ${Currency.PACIFIC_FRANC_SHORT} | ${10}                  | ${exBeneficiaryUser} | ${'Les 100\u00a0F ne seront pas recrédités sur ton pass Culture car il est expiré.'}
