...
import { OldNoTicket } from 'features/bookings/components/TicketBody/NoTicket/OldNoTicket'
...
export const OldTicketBody: FunctionComponent<Props> = ({
  withdrawalDelay,
  withdrawalType,
  subcategoryId,
  beginningDatetime,
  ...
  if (withdrawalType === WithdrawalTypeEnum.no_ticket) return <OldNoTicket />
