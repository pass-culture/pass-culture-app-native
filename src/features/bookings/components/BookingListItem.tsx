...
import { Cutout } from 'ui/svg/Cutout'
  ...
  return display === 'punched' ? (
    <Ticket testID="punched_booking_list_item">
      <Container>
        ...
        <MiddleBlock>
          <Cutout orientation="up" color={theme.designSystem.color.background.default} />
          <StrokeVertical color={theme.designSystem.color.border.subtle} />
          <Cutout orientation="down" color={theme.designSystem.color.background.default} />
        </MiddleBlock>
