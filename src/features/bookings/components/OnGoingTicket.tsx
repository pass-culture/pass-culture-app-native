...
export class OnGoingTicket extends React.PureComponent<OnGoingTicketProps> {
  ...
  render() {
    return <ClippedImage {...getClippedImageProps(this.props.image, this.props.altIcon)} />
  }
}
...
const getClippedImageProps = (image?: string, altIcon?: FC<IconInterface>): ClippedImageProps => {
  const props = {
    clipId: 'onGoingClip',
