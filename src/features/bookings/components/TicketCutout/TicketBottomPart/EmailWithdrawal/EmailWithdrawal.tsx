...
import { EmailReceived } from 'features/bookings/components/TicketCutout/TicketBottomPart/EmailWithdrawal/EmailReceived'
import { EmailWillBeSend } from 'features/bookings/components/TicketCutout/TicketBottomPart/EmailWithdrawal/EmailWillBeSend'
import { TicketVisual } from 'features/bookings/components/TicketCutout/TicketBottomPart/TicketVisual'
...
const EmailWithdrawalContainer = ({ children }) => {
  return (
    <TicketContainer>
      <TicketVisual>
        <StyledEmailSent />
