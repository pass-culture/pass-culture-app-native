...
export interface BookingReponseDouble {
  ended_bookings: Array<BookingReponseBis>
  ongoing_bookings: Array<BookingReponseBis>
}

export const bookingsSnapDouble: BookingReponseDouble = {
  ended_bookings: [
    {
      id: 321,
  ...
  ongoing_bookings: [
    {
      ...
      externalBookingsInfos: [
        { barcode: '111111111', seat: null },
        { barcode: '111111112', seat: 'A12' },
        { barcode: '111111112', seat: 'A13' },
      ],
    },
  ],
}
