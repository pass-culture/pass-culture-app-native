// humanizedId AHD3A
export const offerResponseSnap = {
  id: 116656,
  description:
  ...
  category: { label: 'Cinéma', value: 'EventType.CINEMA' },
  bookableStocks: [
    { id: 118929, beginningDatetime: '2021-01-04T13:30:00', price: 5 },
    { id: 118928, beginningDatetime: '2021-01-03T18:00:00', price: 5 },
  ],
  imageUrl:
...
// humanizedId AGH2M
export const offerDuoReponseSnap = {
  id: 102310,
  description:
  ...
  category: { label: 'Abonnements concerts', value: 'ThingType.MUSIQUE_ABO' },
  bookableStocks: [{ id: 104831, beginningDatetime: null, price: 28 }],
  imageUrl:
...
// humanizedId AGH2K
export const offerDigitalResponseSnap = {
  id: 102309,
  description:
  ...
  category: { label: 'Livre ou carte lecture', value: 'ThingType.LIVRE_EDITION' },
  bookableStocks: [],
  imageUrl:
