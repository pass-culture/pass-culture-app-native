...
import * as useArtistResults from 'features/offer/queries/useArtistResultsQuery'
import * as useSimilarOffers from 'features/offer/queries/useSimilarOffersQuery'
...
const useSimilarOffersSpy = jest
  .spyOn(useSimilarOffers, 'useSimilarOffersQuery')
  .mockReturnValue({ similarOffers: undefined, apiRecoParams: undefined })

jest.spyOn(useArtistResults, 'useArtistResultsQuery').mockReturnValue({
