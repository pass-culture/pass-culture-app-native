...
export function FeedBackVideo({ offerId, offerSubcategory }: Props) {
  ...
  const url =
    reaction === ReactionTypeEnum.LIKE
      ? `https://passculture.qualtrics.com/jfe/form/SV_238Dd248lT6UuJE?category=${offerSubcategory}`
      : `https://passculture.qualtrics.com/jfe/form/SV_3lb1IPodkGiMzWe?category=${offerSubcategory}`
