...
describe('<OfferBody />', () => {
  ...
  describe('ProposedBy section', () => {
    ...
    it('should redirect to venue page when pressing proposed by section when venue is permanent', async () => {
      ...
      await screen.findByText('Proposé par')
  ...
  describe('When wipArtistSectionRefacto FF activated', () => {
    ...
    it('should trigger ConsultArtist log when pressing artist playlist item and offer has several artists', async () => {
      ...
      await user.press(screen.getByLabelText('Stephen King Artiste - page artiste'))
    ...
    it('should trigger ConsultArtist log when pressing artist playlist item and offer has single artist', async () => {
      ...
      await user.press(screen.getByLabelText('Stephen King - page artiste'))
