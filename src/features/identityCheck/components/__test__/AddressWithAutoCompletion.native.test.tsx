...
describe('<AddressWithAutoCompletion/>', () => {
  it('should render correctly', () => {
    const renderAPI = renderAddressWithAutoCompletion()
  ...
  it('should display a list of addresses when user add an address', async () => {
    ...
    const { getByText, getByPlaceholderText } = renderAddressWithAutoCompletion()
  ...
  xit('should save address when clicking on "Continuer"', async () => {
    ...
    const { getByText, findByText, getByPlaceholderText } = renderAddressWithAutoCompletion()
  ...
  xit('should show the generic error message if the API call returns error', async () => {
    ...
    const { getByPlaceholderText } = renderAddressWithAutoCompletion()
...
function renderAddressWithAutoCompletion() {
  // eslint-disable-next-line local-rules/no-react-query-provider-hoc
  return render(reactQueryProviderHOC(<AddressWithAutoCompletion />))
}
